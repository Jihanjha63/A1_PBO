...
public class Main1 {
    ...
    public static void main(String[] args){
        ArrayList<Novel1> novel1 = new ArrayList<>();
        ...
        do{
            ...
            switch(menu){
                case 1:{
                    NovelJadul1 terbaru = new NovelJadul1();
                    ...
                    if(isJudulExist(novel1, terbaru.getJudul()) == -1){
                        novel1.add(terbaru);
                ...
                case 2: {
                    ...
                    if(novel1.size() != 0){
                        for(int i=0; i<novel1.size(); i++){
                            if(novel1.get(i).getClass() == NovelJadul1.class){
                                System.out.println("[Novel "+(i+1)+"]");                        
                                NovelJadul1 jadul = (NovelJadul1) novel1.get(i);
                ...
                case 5:{
                    NovelKini1 baru = new NovelKini1();
                ...
                case 6:{
                    ...
                    if(novel1.size() != 0){
                        for(int i=0; i<novel1.size(); i++){
                            if(novel1.get(i).getClass() == NovelKini1.class){
                                System.out.println("[Novel "+(i+1)+"]");
                                NovelKini1 kini = (NovelKini1) novel1.get(i);
                                kini.showNovel();
